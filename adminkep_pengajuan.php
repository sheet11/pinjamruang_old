  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="./admin_menu.php">Menu Admin Kep</a></li>
      </ul>
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-2 text-center backtop">
        <br><br><br><br>
        <a href="./admin_kep.php"><button class="btn backbutton1"><span class="glyphicon glyphicon-menu-left"></span> Kembali</button></a>
    </div>
    <?php 
  ...
  <div class="row content">
    ...
    <?php 
		...
		$data = mysqli_query($koneksi,"select * from meminjam where id_ruang = '104' order by kode_pinjam desc");
